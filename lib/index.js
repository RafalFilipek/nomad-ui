...
let App = class App {
  ...
  fetchAllocStatus(id) {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this3.allocationInfo.setContent(`CPU: ${_chalk2.default.bold(info.CPU)}\t Memory: ${_chalk2.default.bold(info.MemoryMB)}\t Disk: ${_chalk2.default.bold(info.DiskMB)}\t Networks: ${_chalk2.default.bold(info.Networks)} `);
